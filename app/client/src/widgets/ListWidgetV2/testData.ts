...
export const simpleListInput = {
  ...
  templateWidgets: {
    ...
    eejdk7ibci: {
      ...
      disallowCopy: true,
      isCanvas: true,
      displayName: $t('testData.51c5ffd341f7feb9'),
    ...
    epowimtfiu: {
      boxShadow: "none",
      widgetName: "Image1",
      displayName: $t('testData.91ecc620e83b8bc9'),
    ...
    lbvm24hgek: {
      boxShadow: "none",
      widgetName: "Text1",
      displayName: $t('testData.88847243472d0df9'),
    ...
    "0jneiqpr4z": {
      boxShadow: "none",
      widgetName: "Input1",
      displayName: $t('testData.2ba8d9fcb699f805'),
      iconSVG: "/static/media/icon.9f505595da61a34f563dba82adeb06ec.svg",
      searchTags: ["form", $t('testData.05ed2a304ef25332'), "number", "textarea"],
      topRow: 1,
      bottomRow: 8,
      parentRowSpace: 10,
      labelWidth: 5,
      ...
      labelPosition: $t('testData.2a0406f66653c122'),
      labelStyle: "",
      inputType: "TEXT",
      isDisabled: false,
      key: "u1lqu77ftt",
      ...
      accentColor: "{{appsmith.theme.colors.primaryColor}}",
      isVisible: true,
      label: $t('testData.c7c04f6dca6754fd'),
      version: 2,
      parentId: "y57vj73onh",
      labelAlignment: "left",
      renderMode: "CANVAS",
  ...
  templateWidgets: {
    ...
    fs2d2lqjgd: {
      ...
      listData: [
        {
          id: "001",
          name: $t('testData.26b9ac584d21e49d'),
          img: getAssetUrl(`${ASSETS_CDN_URL}/widgets/default.png`),
        },
        {
          id: "002",
          name: $t('testData.a752e33d9cab7bac'),
          img: getAssetUrl(`${ASSETS_CDN_URL}/widgets/default.png`),
        },
        {
          id: "003",
          name: $t('testData.3b67b9e3f1ca9e73'),
          img: getAssetUrl(`${ASSETS_CDN_URL}/widgets/default.png`),
        },
      ],
      pageSize: 3,
      ...
      hideCard: false,
      isDeprecated: false,
      displayName: $t('testData.30bddf259b4b9040'),
      key: "fq71tyxnm1",
