...
export const unsafeFunctionForEval = [
  "XMLHttpRequest",
  "setImmediate",
  $t('DynamicBindingUtils.d0d5b63d5841e2e3'),
];
...
> = {
  [PropertyEvaluationErrorType.VALIDATION]: (propertyPath: string) =>
    $t('DynamicBindingUtils.a1ff2c5d2804ba56', {propertyPath: propertyPath}),
  [PropertyEvaluationErrorType.PARSE]: () => $t('DynamicBindingUtils.ccf86d08a1c7555d'),
  [PropertyEvaluationErrorType.LINT]: () => $t('DynamicBindingUtils.105e0e64f1ef020b'),
};
